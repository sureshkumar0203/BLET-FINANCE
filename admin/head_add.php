...
if(isset($_POST["submit"])<>''){
	$num=$db->countRows('payment_heads',"firm_name='$_POST[firm_name]'");
	if($num>0){
		header("Location:head_add.php?msg=exist");
		exit;
	}else{
		//insert to firms table
		$string="heads='$_POST[firm_name]'";
		$ins_id=$db->insertSet("payment_heads",$string);
		
		header("Location:head_add.php?msg=added");
		exit;
	}
}
?>
                ...
                <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <td class="midboxbg"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td width="50%" align="left" valign="middle"><h2>Add Head</h2></td>
                  ...
                  <tr>
					...
					<form action="" method="post" id="frm" enctype="multipart/form-data">
                      <table width="90%" border="0" align="left" cellpadding="0" cellspacing="0" style="margin-left:10px;">
                        ...
                        <tr>
                          <td align="left" valign="middle" class="text1">Head Name : </td>
