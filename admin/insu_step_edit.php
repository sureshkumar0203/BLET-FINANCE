...
if(isset($_REQUEST['action']) && $_REQUEST['action'] == 'insert'){
	...
	$db->updateTable("insurance_step",$string,"id='$_REQUEST[id]'");
              ...
              <tr>
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0" class="righttableborder2">
                  ...
                  <tr>
					...
					<form action="insu_step_edit.php?action=insert&id=<?php echo $_REQUEST['id'];?>" method="post" id="frm">
					  <table width="100%" border="0" cellspacing="0" cellpadding="0">
					    <tr>
					      <td width="14%" height="40" align="left" valign="top">Step Description :<span class="level_msg"></span></td>					      
                          <td width="86%" height="40" align="left" valign="middle">
                          <textarea name="vehicle_no" class="validate[required] textfield121" id="vehicle_no" style="border:solid 1px; border-color:#CCC; width:550px; height:200px;" autocomplete="off"><?php echo $db->getDataFromTable("insurance_step","name","id='$_REQUEST[id]'"); ?></textarea></td>
					      </tr>
					    <tr>
