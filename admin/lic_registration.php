...
if(isset($_POST["submit"])<>'')
{
	...
	$num=$db->countRows('lic_registration',"policy_no='$policy_no'");
	if($num>0)
	{
		header("Location:lic_registration.php?msg=exist");
	}
	else
	{
		//insert to lic_registration table
		...
		$db->insertSet("lic_registration",$string);
		header("Location:lic_registration.php?msg=added");
	}
}
?>
                ...
                <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <td class="midboxbg"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td width="50%" align="left" valign="middle"><h2>LIC Registration</h2></td>
					...
					<form action="" method="post" id="frm" enctype="multipart/form-data">
                      <table width="90%" border="0" align="left" cellpadding="0" cellspacing="0" style="margin-left:10px;">
                        ...
                        <tr>
                          ...
                          <input name="name_policy_holder" type="text" class="validate[required] textfield121" id="name_policy_holder" style="text-transform:uppercase;" autocomplete="off"/>
                          </td>
                          <td height="25" colspan="2" align="left" valign="middle">&nbsp;</td>
                         </tr>
                        <tr>
                          <td width="19%" align="left" valign="middle" class="text1"> DOB : </td>
                          <td width="78%" height="30" align="left" valign="bottom" class="text1">
                          ...
                          <td width="3%" height="25" colspan="2" align="left" valign="middle">&nbsp;</td>
                           ...
                           <tr>
                             ...
                             <td height="30" align="left" valign="bottom" class="text1">
                             <input name="age" type="text" class="validate[required] textfield121" id="age" autocomplete="off" maxlength="3"/>
                             </td>
                             <td height="25" colspan="2" align="left" valign="middle">&nbsp;</td>
                           </tr>
                           <tr>
                             ...
                             <td height="30" align="left" valign="bottom" class="text1">
                             <input name="policy_no" type="text" class="validate[required] textfield121" id="policy_no" style="text-transform:uppercase;" autocomplete="off"/>
                             </td>
                             <td height="25" colspan="2" align="left" valign="middle">&nbsp;</td>
                           </tr>
                           <tr>
                             ...
                             <td height="30" align="left" valign="bottom" class="text1">
                             <input name="premium_amount" type="text" class="validate[required] textfield121" id="premium_amount" onBlur="extractNumber(this,2,false)" onKeyUp="extractNumber(this,2,false)" onKeyPress="return blockNonNumbers(this, event, true, false);"/>
                             </td>
                             <td height="25" colspan="2" align="left" valign="middle">&nbsp;</td>
                           </tr>
                           <tr>
                            ...
                            <option value="Quarterly">Haly Yearly</option>
                           ...
                           <tr>
                             ...
                             <td height="30" align="left" valign="bottom" class="text1">
                           <input name="date_commencement" type="text" class="datepick validate[required] textfield121" id="date_commencement" autocomplete="off" readonly/>  
                           <span class="level_msg">(yyyy-m-d) </span>
                             </td>
                             <td height="25" colspan="2" align="left" valign="middle">&nbsp;</td>
                           </tr>
                           <tr>
                             ...
                             <td height="30" align="left" valign="bottom" class="text1">
                             <input name="date_maturity" type="text" class="datepick validate[required] textfield121" id="date_maturity" autocomplete="off" readonly/> 
                             <span class="level_msg">(yyyy-m-d) </span>
                             </td>
                             <td height="25" colspan="2" align="left" valign="middle">&nbsp;</td>
                           </tr>
                           <tr>
                             ...
                             <td height="30" align="left" valign="bottom" class="text1">
                             <input name="sum_assured" type="text" class="validate[required] textfield121" id="sum_assured" autocomplete="off"/>
                             </td>
                             <td height="25" colspan="2" align="left" valign="middle">&nbsp;</td>
                           </tr>
                           <tr>
                             ...
                             <td height="30" align="left" valign="bottom" class="text1">
                             <input name="nominee" type="text" class="validate[required] textfield121" id="nominee" style="text-transform:uppercase;"/>
                             </td>
                             <td height="25" colspan="2" align="left" valign="middle">&nbsp;</td>
                           </tr>
                           <tr>
                             ...
                             <td height="30" align="left" valign="bottom" class="text1">
                             <input name="table_term" type="text" class="validate[required] textfield121" id="table_term" style="text-transform:uppercase;"/>
                             </td>
                             <td height="25" colspan="2" align="left" valign="middle">&nbsp;</td>
                           </tr>
                           <tr>
                             ...
                             <td height="30" align="left" valign="bottom" class="text1">
                             <input name="name_agent" type="text" class="validate[required] textfield121" id="name_agent" style="text-transform:uppercase;"/></td>
                             <td height="25" colspan="2" align="left" valign="middle">&nbsp;</td>
                           </tr>
                           <tr>
                          <td align="left" valign="middle" class="text1">Agent Contact No. : </td>
                          <td height="30" align="left" valign="bottom" class="text1">
                          <input name="agent_contact_no" type="text" class="validate[required] textfield121" id="agent_contact_no" />
                          </td>
                          <td height="25" colspan="2" align="left" valign="middle">&nbsp;</td>
                         </tr>
                        ...
                        <tr>
                         ...
                         <td height="30" align="left" valign="bottom" class="text1">
                         <input name="policy_branch" type="text" class="validate[required] textfield121" id="policy_branch" style="text-transform:uppercase;"/>
                         </td>
                         <td height="25" colspan="2" align="left" valign="middle">&nbsp;</td>
                       </tr>                           
                        <tr>
