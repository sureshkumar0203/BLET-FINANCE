...
if(isset($_POST['submit'])<>'')
{
	...
	$db->insertSet("other_details",$string);
	header("Location:add_others.php?msg=added");
	exit;
}
?>
                ...
                <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <td class="midboxbg"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td width="50%" align="left" valign="middle"><h2>Add Others</h2></td>
                      ...
                      <table width="90%" border="0" align="left" cellpadding="0" cellspacing="0" style="margin-left:10px;">
                       ...
                       <tr>
                         ...
                         <select name="payment_head_id" class="validate[required]" id="payment_head_id" style="border:1px solid #CCC; height:25px; width:150px;">
                            ...
                            <option value="<?php echo $val_head['id']; ?>"><?php echo $val_head['heads']; ?></option>
                             <?php } ?>
                          </select>
                         </td>
                         <td height="25" colspan="2" align="left" valign="middle">&nbsp;</td>
                        ...
                        <tr>
                          ...
                          <td height="30" align="left" valign="bottom" class="text1">
                          <input name="paid_to" type="text" class="validate[required] textfield121" id="paid_to" style="text-transform:uppercase;" autocomplete="off"/>
                          </td>
                          <td height="25" colspan="2" align="left" valign="middle">&nbsp;</td>
                         </tr>
                         
                         <tr>
                          <td width="18%" align="left" valign="middle" class="text1"> Amount : </td>
                          <td width="63%" height="30" align="left" valign="bottom" class="text1">
                            <input name="amount" type="text" class="validate[required] textfield121" id="amount" onBlur="extractNumber(this,2,false)" onKeyUp="extractNumber(this,2,false)" onKeyPress="return blockNonNumbers(this, event, true, false);"/>
                          </td>
           ...
           <select name="mode_of_payment" id="mode_of_payment" class="validate[required]" onChange="showHide(this.value);" style="border:1px solid #CCC; height:25px; width:150px;">
                          ...
                          <td height="25" colspan="2" align="left" valign="middle">&nbsp;</td>
                           ...
                           <tr id="tr_bank" style="display:none;">
                            ...
                            <table width="90%" border="0" align="left" cellpadding="0" cellspacing="0">
                             <tr>
                             <td width="20%" align="left" valign="middle" class="text1">Bank Name : </td>
                             <td width="76%" height="30" align="left" valign="bottom" class="text1">
                             ...
                             <?php foreach($db->fetch('bank_details',"","bank_name","","") as $val_bank) { ?>
                              <option value="<?php echo $val_bank['id'];?>"><?php echo $val_bank['bank_name'];?></option>
                             <?php } ?>
                              </select>
                             </td>
                            ...
                            <tr>
                             ...
                             <td height="30" align="left" valign="bottom" class="text1">
                             <input name="cheque_no" type="text" id="cheque_no" class="validate[required] textfield121"/>
                             </td>
                             <td height="25" colspan="2" align="left" valign="middle">&nbsp;</td>
                           </tr>
                             </table>
                           ...
                           <tr>
                             ...
                             <td height="30" align="left" valign="bottom" class="text1">
                             <input name="payment_date" type="text" id="payment_date" class="datepick validate[required] textfield121" readonly/>
                          <span class="level_msg">(yyyy-m-d) </span>
                           ...
                           <tr>
                             ...
                             <td height="30" align="left" valign="bottom" class="text1">
                              <input name="date_from" type="text" id="date_from" class="datepick validate[required] textfield121" readonly/>
                          <span class="level_msg">(yyyy-m-d) </span>
                             </td>
                             <td height="25" colspan="2" align="left" valign="middle">&nbsp;</td>
                           </tr>
                           <tr>
                             ...
                             <td height="30" align="left" valign="bottom" class="text1">
                            <input name="date_to" type="text" id="date_to" class="datepickFuture validate[required] textfield121" readonly/>
                          <span class="level_msg">(yyyy-m-d) </span>
                             </td>
                             <td height="25" colspan="2" align="left" valign="middle">&nbsp;</td>
                           </tr>
                           ...
                           <tr>
                             ...
                             <td height="30" align="left" valign="bottom" class="text1">
                            <input name="alert_others" type="text" class="validate[required] textfield121" id="alert_others" onKeyPress="return onlyNumbers(event);"/></td>
                             <td height="25" colspan="2" align="left" valign="middle">&nbsp;</td>
                           </tr>
                           ...
                           <tr>
                             <td height="10" colspan="4" align="left" class="headingtext">
                             <textarea name="remarks" id="remarks" rows="4" cols="40" style="border:1px solid #CCC;"></textarea></td>
                           </tr>
