                ...
                <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <td class="midboxbg"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td width="50%" align="left" valign="middle"><h2>Manage Vehicle Type</h2></td>
                          <td width="50%" align="right" valign="middle"><h2><a href="add_vehicle_type.php" class="linkButton">Add New </a></h2></td>
                        </tr>
                      </table></td>
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
					...
					<table height="61" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#ACACAC"  class="tablesorter" id="sort_table" width="100%">
                      <thead>
                        <tr>
                          <th height="27" align="left" valign="middle" class="fetch_headers"> Vehicle Type</th>
                      ...
                      <tbody>
                        <?php
						 $num=$db->countRows('vehicle_types');
						 foreach($db->fetch('vehicle_types') as $res) {

			             ?>
                        <tr bgcolor="<?=$color;?>"  onmouseover="this.style.backgroundColor='#E6E6E6'" onMouseOut="this.style.backgroundColor=''">
                          <td height="25" align="left" class="fetch_contents"><?php echo $res[vtype]; ?></td>
						   <td width="7%" align="center" bgcolor="<?=$color;?>" class="fetch_contents">
						   <a href="edit_vehicle_type.php?id=<?php echo $res[id];?>"  class="linktext">
