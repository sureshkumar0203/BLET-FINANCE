...
{
	$num=$db->countRows('vehicle_types',"vtype='$_POST[vtype]'");
	if($num>0)
	{
		header("Location:add_vehicle_type.php?msg=exist");
	}
	else
	{
		//insert to category table
		$string="vtype='$_POST[vtype]'";
		$ins_id=$db->insertSet("vehicle_types",$string);
		header("Location:add_vehicle_type.php?msg=added");
	}
}
?>
                ...
                <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <td class="midboxbg"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td width="50%" align="left" valign="middle"><h2>Add Vehicle Type </h2></td>
					...
					<form action="" method="post" id="frm" enctype="multipart/form-data">
                      <table width="90%" border="0" align="left" cellpadding="0" cellspacing="0" style="margin-left:10px;">
                        ...
                        <tr>
						  ...
						  <input name="vtype" type="text" class="validate[required] textfield2" id="vtype"></td>
