...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
   <tr>
    ...
    <td class="white_heading" align="right" style="padding-right:20px;">&nbsp;</td>
  </tr>
  ...
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                <td>&nbsp;</td>
                <td align="left" valign="top"  height="40"><font color="#000000"><strong>FINANCE</strong></font>  Report from dated 
    <font color="#FF0000"><?php echo date("jS M,Y",strtotime($_REQUEST["from_date_all"]));?> </font> to
    <font color="#FF0000"><?php echo date("jS M,Y",strtotime($_REQUEST["to_date_all"])); ?></font></td>
                <td>&nbsp;</td>
                </tr>
                
                <tr>
                <td>&nbsp;</td>
                <td width="1242" align="left" valign="top" height="35">
                ...
                <td width="13%" height="30" style="padding-left:5px;"><?php if(isset($_REQUEST["payment_status"])=="Paid") { ?> Paid Date <?php } ?> <?php if(isset($_REQUEST["payment_status"])=="Unpaid") { ?> Due Date <?php } ?> <?php if(isset($_REQUEST["payment_status"])=="") { ?> Both <?php } ?></td>
                ...
                <?php if(isset($_REQUEST["payment_status"])=="Unpaid") { ?> 
                ...
                <td style="padding-left:5px;"><?php echo $val_inst["installment_per_month"]; ?></td>
                </tr>
                <?php 
                ...
                <?php //if($num==0) { ?>
                <tr>
                <td height="25" colspan="10" align="right" class="error" style="padding-right:75px;">Total = Rs. <?php echo $finance_total; ?></td>
                </tr>
                <?php //} ?>
                </table>
                ...
                $ins_count=1;
				if(isset($_REQUEST["all_status"])=="tobepaid") {
				...
				if(isset($_REQUEST["all_status"])=="paid") {
				...
				if(isset($_REQUEST["all_status"])=="both") {
                ...
                <tr>
                <td width="38">&nbsp;</td>
                <td height="40" align="left" valign="top"><font color="#000000"><strong>INSURANCE</strong></font>  Report from dated 
    <font color="#FF0000"><?php echo date("jS M,Y",strtotime($_REQUEST["from_date_all"]));?> </font> to
    <font color="#FF0000"><?php echo date("jS M,Y",strtotime($_REQUEST["to_date_all"])); ?></font></td>
                </tr>
                ...
                <tr>
                <td height="25" colspan="7" align="right" class="error" style="padding-right:30px;">Total = Rs. <?php echo $ins_tot; ?></td>
                </tr>
                ...
                <tr>
                <td>&nbsp;</td>
                <td height="40" align="left" valign="top"><strong><font color="#000000">ROAD TAX </font></strong> Report from dated 
    <font color="#FF0000"><?php echo date("jS M,Y",strtotime($_REQUEST["from_date_all"]));?> </font> to
    <font color="#FF0000"><?php echo date("jS M,Y",strtotime($_REQUEST["to_date_all"])); ?></font></td>
                <td>&nbsp;</td>
                </tr>
                ...
                <td width="20%" height="30" style="padding-left:5px;">Firm Name </td>
                <td width="21%" height="30" style="padding-left:5px;">
				<?php if(isset($_REQUEST["all_status"])=="tobepaid") { ?>Due Date <?php } ?>
                <?php if(isset($_REQUEST["all_status"])=="paid") { ?>Payment Detail<?php } ?>
                 <?php if(isset($_REQUEST["all_status"])=="both") { ?>Payment Status<?php } ?>
                </td>
                ...
                <tr>
                <td>&nbsp;</td>
                <td height="40" align="left" valign="top"><font color="#000000"><strong>FITNESS</strong></font> Report from dated 
    <font color="#FF0000"><?php echo date("jS M,Y",strtotime($_REQUEST["from_date_all"]));?> </font> to
    <font color="#FF0000"><?php echo date("jS M,Y",strtotime($_REQUEST["to_date_all"])); ?></font></td>
                <td>&nbsp;</td>
                </tr>
                ...
                <tr>
                <td>&nbsp;</td>
                <td height="40" align="left" valign="top"><font color="#000000"><strong>PERMIT</strong></font> Report from dated 
    <font color="#FF0000"><?php echo date("jS M,Y",strtotime($_REQUEST["from_date_all"]));?> </font> to
    <font color="#FF0000"><?php echo date("jS M,Y",strtotime($_REQUEST["to_date_all"])); ?></font></td>
                <td>&nbsp;</td>
                </tr>
				...
				//$rto = $db->strRecordID("rto_office" , "*", "id='$veh_per[rto_office]'");
                ?>
                <tr>
                ...
                <?php //if($per_num==0) { ?>
                <tr>
                <td height="23" colspan="7" align="right" class="error" style="padding-right:30px;">Total = Rs. <?php echo $permit_total; ?></td>
                </tr>
                <?php //} ?>
                </table>
                </td>
                ...
                <tr>
                <td>&nbsp;</td>
                <td height="40" align="left" valign="top"><font color="#000000"><strong>DL</strong></font> Report from dated 
    <font color="#FF0000"><?php echo date("jS M,Y",strtotime($_REQUEST["from_date_all"]));?> </font> to
    <font color="#FF0000"><?php echo date("jS M,Y",strtotime($_REQUEST["to_date_all"])); ?></font></td>
                <td>&nbsp;</td>
                </tr>
