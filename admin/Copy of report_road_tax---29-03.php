                    ...
                    <table width="40%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                       ...
                       <input name="end_date" type="text" id="end_date" class="textfield121d" readonly value="<?php echo $_REQUEST[end_date];?>"/></td>
                        ...
                        <td width="12%" align="center" valign="middle"><input type="image" name="imageField" src="images/searchButton.png" /></td>
                        <td width="7%" align="center" valign="middle" bgcolor="#FF0000"><input type="checkbox" name="split" id="split" <?php if($_REQUEST[split]){?> checked="" <?php } ?>></td>
                      </tr>
                    </table>
                    </form>
                    </td>
                    ...
                    <td align="left" valign="bottom">
                        <table width="50%" border="1" cellspacing="0" cellpadding="0" style="border-collapse:collapse;" bordercolor="#006699">
                          <tr>
                            ...
                            <td width="12%" height="22" align="center" valign="middle" bgcolor="#990000" ><a href="report_road_tax_paid_csv.php?start_date=<?php echo $_REQUEST[start_date];?>&end_date=<?php echo $_REQUEST[end_date];?>&firms=<?php echo $_REQUEST[firms];?>"><img src="images/xls.png" width="16" height="16" border="0" /></a></td>
                          </tr>
                        </table>
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                          ...
                          <tr>
                            ...
                            <td width="12%" align="center" valign="middle" bgcolor="#00CCCC"><a href="report_road_tax_unpaid_csv.php?start_date=<?php echo $_REQUEST[start_date];?>&end_date=<?php echo $_REQUEST[end_date];?>&firms=<?php echo $_REQUEST[firms];?>"><img src="images/xls.png" width="16" height="16" border="0" /></a></td>
                          </tr>
                        </table>
                            </td>
                          </tr>
