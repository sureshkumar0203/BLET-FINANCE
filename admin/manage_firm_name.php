...
{
	$num=$db->countRows('company',"cat_id='$_REQUEST[id]'");
	if($num>0)
	{
	...
	{
		$db->deleteFromTable("category","id='$_REQUEST[id]'");
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0" style="border:solid 1px; border-color:#CCC;">
                ...
                <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <td class="midboxbg"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td width="50%" align="left" valign="middle"><h2>Manage Firm Name</h2></td>
                          <td width="50%" align="right" valign="middle"><h2><a href="add_firm_name.php" class="linkButton">Add New </a></h2></td>
                        </tr>
                      </table></td>
              ...
              <tr>
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    <td>&nbsp;</td>
                    <td align="center" valign="top" class="noRecords2">To delete this category 1st delete all the Sub Category belongs to this category.</td>
                    <td>&nbsp;</td>
                  </tr>
                  <?php } ?>
                  <tr>
                  ...
                  <tr>
					...
					<table height="61" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#ACACAC"  class="tablesorter" id="sort_table" width="100%">
                      <thead>
                        <tr>
                          <th height="27" align="left" valign="middle" class="fetch_headers">Firm Name </th>
                      ...
                      <tbody>
                        <?php
						 $num=$db->countRows('firms');
						 foreach($db->fetch('firms') as $res) {
			             ?>
                        <tr bgcolor="<?=$color;?>"  onmouseover="this.style.backgroundColor='#E6E6E6'" onMouseOut="this.style.backgroundColor=''">
                          <td align="left" class="fetch_contents"><?php echo $res["firm_name"]; ?></td>
						   <td width="7%" align="center" bgcolor="<?=$color;?>" class="fetch_contents">
						   <a href="edit_firm_name.php?id=<?php echo $res["id"];?>"  class="linktext">
