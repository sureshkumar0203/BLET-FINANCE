...
if(isset($_POST["submit"])<>'')
{
	...
	$num=$db->countRows('mediclaim_registration',"idcard_no='$idcard_no'");
	if($num>0)
	{
		header("Location:hi_registration.php?msg=exist");
	}
	else
	{
		//insert to mediclaim_registration table
		...
		$db->insertSet("mediclaim_registration",$string);
		header("Location:hi_registration.php?msg=added");
	}
}
?>
                ...
                <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <td class="midboxbg"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td width="50%" align="left" valign="middle"><h2>Health Insurance Registration</h2></td>
					...
					<form action="" method="post" id="frm" enctype="multipart/form-data">
                      <table width="90%" border="0" align="left" cellpadding="0" cellspacing="0" style="margin-left:10px;">
                       ...
                       <tr>
                         ...
                         <input name="policy_no" type="text" class="validate[required] textfield3" id="policy_no" style="text-transform:uppercase;" autocomplete="off"/>
                         </td>
                       ...
                       <tr>
                         ...
                         <td height="30" align="left" valign="bottom" class="text1">
                         <input name="idcard_no" type="text" class="validate[required] textfield121" id="idcard_no" style="text-transform:uppercase;" autocomplete="off"/>
                         </td>
                         <td height="25" colspan="2" align="left" valign="middle">&nbsp;</td>
                       </tr>
                        ...
                        <tr>
                          ...
                          <td height="30" align="left" valign="bottom" class="text1">
                          <input name="policy_holder_name" type="text" class="validate[required] textfield121" id="policy_holder_name" style="text-transform:uppercase;" autocomplete="off"/>
                          </td>
                          <td height="25" colspan="2" align="left" valign="middle">&nbsp;</td>
                         </tr>
                        ...
                        <tr>
                          ...
                          <input name="dob" type="text" id="dob" class="datepick validate[required] textfield121" readonly/>
                          ...
                          <td width="3%" height="25" colspan="2" align="left" valign="middle">&nbsp;</td>
                           ...
                           <tr>
                             ...
                             <td height="30" align="left" valign="bottom" class="text1">
                             <input name="age" type="text" class="validate[required] textfield121" id="age" autocomplete="off"/>
                             </td>
                             <td height="25" colspan="2" align="left" valign="middle">&nbsp;</td>
                           </tr>
                           <tr>
                             ...
                             <td height="30" align="left" valign="bottom" class="text1">
                             <input name="sum_assured" type="text" class="validate[required] textfield121" id="sum_assured" onBlur="extractNumber(this,2,false)" onKeyUp="extractNumber(this,2,false)" onKeyPress="return blockNonNumbers(this, event, true, false);"/>
                             </td>
                             <td height="25" colspan="2" align="left" valign="middle">&nbsp;</td>
                           </tr>
                           <tr>
                             ...
                             <td height="30" align="left" valign="bottom" class="text1">
                             <input name="premium" type="text" class="validate[required] textfield121" id="premium" onBlur="extractNumber(this,2,false)" onKeyUp="extractNumber(this,2,false)" onKeyPress="return blockNonNumbers(this, event, true, false);"/>
                             </td>
                             <td height="25" colspan="2" align="left" valign="middle">&nbsp;</td>
                           </tr>
                           <tr>
                             ...
                             <td height="30" align="left" valign="bottom" class="text1">
                              <input name="discount" type="text" class="validate[required] textfield121" id="discount" onBlur="extractNumber(this,2,false)" onKeyUp="extractNumber(this,2,false)" onKeyPress="return blockNonNumbers(this, event, true, false);"/>
                             </td>
                             <td height="25" colspan="2" align="left" valign="middle">&nbsp;</td>
                           </tr>
                           <tr>
                             ...
                             <td height="30" align="left" valign="bottom" class="text1">
                             <input name="net_premium" type="text" class="validate[required] textfield121" id="net_premium" onBlur="extractNumber(this,2,false)" onKeyUp="extractNumber(this,2,false)" onKeyPress="return blockNonNumbers(this, event, true, false);"/>
                             </td>
                             <td height="25" colspan="2" align="left" valign="middle">&nbsp;</td>
                           </tr>
                           <tr>
                             ...
                             <td height="30" align="left" valign="bottom" class="text1">
                             <input name="service_tax" type="text" class="validate[required] textfield121" id="service_tax" onBlur="extractNumber(this,2,false)" onKeyUp="extractNumber(this,2,false)" onKeyPress="return blockNonNumbers(this, event, true, false);"/>
                             </td>
                             <td height="25" colspan="2" align="left" valign="middle">&nbsp;</td>
                           </tr>
                           <tr>
                             ...
                             <td height="30" align="left" valign="bottom" class="text1">
                             <input name="hospital_allowance" type="text" class="validate[required] textfield121" id="hospital_allowance" onBlur="extractNumber(this,2,false)" onKeyUp="extractNumber(this,2,false)" onKeyPress="return blockNonNumbers(this, event, true, false);"/>
                             </td>
                             <td height="25" colspan="2" align="left" valign="middle">&nbsp;</td>
                           </tr>
                           <tr>
                           ...
                           <tr>
                             ...
                             <td height="30" align="left" valign="bottom" class="text1">
                             <input name="tax_benefit" type="text" class="validate[required] textfield121" id="tax_benefit" onBlur="extractNumber(this,2,false)" onKeyUp="extractNumber(this,2,false)" onKeyPress="return blockNonNumbers(this, event, true, false);"/>
                             </td>
                             <td height="25" colspan="2" align="left" valign="middle">&nbsp;</td>
                           </tr>
