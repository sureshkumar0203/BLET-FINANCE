...
{
	$num=$db->countRows('firms',"firm_name='$_POST[firm_name]'");
	if($num>0)
	{
		header("Location:add_firm_name.php?msg=exist");
	}
	else
	{
		//insert to firms table
		$string="firm_name='$_POST[firm_name]'";
		$ins_id=$db->insertSet("firms",$string);
		header("Location:add_firm_name.php?msg=added");
	}
}
?>
                ...
                <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <td class="midboxbg"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td width="50%" align="left" valign="middle"><h2>Add Firm </h2></td>
					...
					<form action="" method="post" id="frm" enctype="multipart/form-data">
                      <table width="90%" border="0" align="left" cellpadding="0" cellspacing="0" style="margin-left:10px;">
                        ...
                        <tr>
						  ...
						  <input name="firm_name" type="text" class="validate[required] textfield2" id="firm_name"></td>
