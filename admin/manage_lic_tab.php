...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td>&nbsp;</td>
                    <td align="right"><h2><a href="lic_registration.php" class="linkButton">Add New </a></h2></td>
                    <td>&nbsp;</td>
                  </tr>
                  <tr>
                    <td>&nbsp;</td>
					...
					<table width="500" border="0" cellspacing="0" cellpadding="0">
					  <tr>
					    <td width="43%" height="25" class="text1">Name / Policy No. / Agent contact No. </td>
					    <td width="57%">&nbsp;</td>
					    </tr>
					  <tr>
						<td width="43%">
					    ...
					    <td width="57%" align="left"><input type="image" name="imageField" src="images/searchButton.png"></td>
					  </tr>
					</table>
					</form>
					</td>
                  ...
                  <tr>
					...
					<table height="61" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#ACACAC"  class="tablesorter" id="sort_table" width="100%">
					  ...
					  <?php
						$sch="";
						if($_REQUEST[name_policy_no_contact_no]!="")
						{
                        ...
                        <tr bgcolor="<?=$color;?>"  onmouseover="this.style.backgroundColor='#E6E6E6'" onMouseOut="this.style.backgroundColor=''">
                          ...
                          <td align="left" class="fetch_contents" style="padding-left:3px;"><?php  echo date("jS M,Y",strtotime($lic_info[date_maturity]));  ?></td>
                          <td align="left" class="fetch_contents" style="padding-left:3px;"><?php  echo $lic_info[name_agent];  ?></td>
                          <td align="left" class="fetch_contents" style="padding-left:3px;"><?php  echo $lic_info[agent_contact_no];  ?></td>
                          <td align="left" class="fetch_contents" style="padding-left:3px;"><?php  echo $lic_info[policy_branch];  ?></td>
