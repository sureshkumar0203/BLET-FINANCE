...
if(isset($_POST["submit"])<>''){
	...
	$num=$db->countRows('vehicle_registration',"vehicle_no='$vehicle_no'");
	if($num>0){
		header("Location:vehicle_registration.php?msg=exist");
	}else{
		
		//insert to vehicle_registration table
		...
		$db->insertSet("vehicle_registration",$string);
		header("Location:vehicle_registration.php?msg=added");
	}
}
?>
                ...
                <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <td class="midboxbg"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td width="50%" align="left" valign="middle"><h2>Vehicle Registration</h2></td>
                  ...
                  <tr>
					...
					<form action="" method="post" id="frm" enctype="multipart/form-data">
                      <table width="90%" border="0" align="left" cellpadding="0" cellspacing="0" style="margin-left:10px;">                   
                        ...
                        <tr>
                          <td align="left" valign="middle" class="text1">Vehicle No. : 
						</td>
                          <td height="30" align="left" valign="bottom" class="text1">
                          <table width="240" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <td width="20">
         <input name="vehicle_no1" type="text" class="validate[required]" id="vehicle_no1" style="text-transform:uppercase; width:20px; border:1px solid #999;" autocomplete="off" maxlength="1"/>
                            </td>
                            <td width="20">
         <input name="vehicle_no2" type="text" class="validate[required]" id="vehicle_no2" style="text-transform:uppercase; width:20px; border:1px solid #999;" autocomplete="off" maxlength="1"/>
                            </td>
                            <td width="20">&nbsp;</td>
                            <td width="20">
                            <input name="vehicle_no3" type="text" class="validate[required]" id="vehicle_no3" style="text-transform:uppercase; width:20px; border:1px solid #999;" autocomplete="off" maxlength="1"/>
                            </td>
                            <td width="20">
                            <input name="vehicle_no4" type="text" class="validate[required]" id="vehicle_no4" style="text-transform:uppercase; width:20px; border:1px solid #999;" autocomplete="off" maxlength="1"/>
                            </td>
                            <td width="20">
                            <input name="vehicle_no5" type="text" class="validate[required]" id="vehicle_no5" style="text-transform:uppercase; width:20px; border:1px solid #999;" autocomplete="off" maxlength="1"/>
                            </td>
                            <td width="20">
                            <input name="vehicle_no6" type="text" class="validate[required]" id="vehicle_no6" style="text-transform:uppercase; width:20px; border:1px solid #999;" autocomplete="off" maxlength="1"/>
                            </td>
                            <td width="20">&nbsp;</td>
                            <td width="20">
                            <input name="vehicle_no7" type="text" class="validate[required]" id="vehicle_no7" style="text-transform:uppercase; width:20px; border:1px solid #999;" autocomplete="off" maxlength="1"/>
                            </td>
                            <td width="20">
                            <input name="vehicle_no8" type="text" class="" id="vehicle_no8" style="text-transform:uppercase; width:20px; border:1px solid #999;" autocomplete="off" maxlength="1"/>
                            </td>
                            <td width="20"><input name="vehicle_no9" type="text" class="" id="vehicle_no9" style="text-transform:uppercase; width:20px; border:1px solid #999;" autocomplete="off" maxlength="1"/></td>
                            <td width="20">
                            <input name="vehicle_no10" type="text" class="" id="vehicle_no10" style="text-transform:uppercase; width:20px; border:1px solid #999;" autocomplete="off" maxlength="1"/>
                            </td>
                          </tr>
                        </table>
                         </td>
                        ...
                        <tr>
                          <td width="23%" align="left" valign="middle" class="text1"> Type of Vehicle: </td>
                          <td width="74%" height="30" align="left" valign="bottom" class="text1">
                          ...
                          <td width="3%" height="25" colspan="2" align="left" valign="middle">&nbsp;</td>
                           ...
                           <tr>
                             ...
                             <td height="30" align="left" valign="bottom" class="text1">
                             <input name="manufacture_name" type="text" class="validate[required] textfield121" id="manufacture_name" style="text-transform:uppercase;" autocomplete="off"/>
                             </td>
                             <td height="25" colspan="2" align="left" valign="middle">&nbsp;</td>
                           </tr>
                           <tr>
                             ...
                             <td height="30" align="left" valign="bottom" class="text1">
                             <input name="year_of_manufacturing" type="text" class="datepick validate[required] textfield121" id="year_of_manufacturing" readonly="readonly"/>
                             </td>
                             <td height="25" colspan="2" align="left" valign="middle">&nbsp;</td>
                           </tr>
                           <tr>
                             ...
                             <td height="30" align="left" valign="bottom" class="text1">
                           <input name="vehicle_model" type="text" class="validate[required] textfield121" id="vehicle_model" style="text-transform:uppercase;" autocomplete="off"/>
                             </td>
                             <td height="25" colspan="2" align="left" valign="middle">&nbsp;</td>
                           </tr>
                           <tr>
                           ...
                           <tr>
                             ...
                             <td height="30" align="left" valign="bottom" class="text1"><input name="carrying_capacity" type="text" class="validate[required] textfield121" id="carrying_capacity" onBlur="extractNumber(this,2,false)" onKeyUp="extractNumber(this,2,false)" onKeyPress="return blockNonNumbers(this, event, true, false);"/></td>
                             <td height="25" colspan="2" align="left" valign="middle">&nbsp;</td>
                           </tr>
                           <tr>
                             <td align="left" valign="middle" class="text1">Cost of vehicle : </td>
                             <td height="30" align="left" valign="bottom" class="text1">
                             <input name="cost_of_vehicle" type="text" class="validate[required] textfield121" id="cost_of_vehicle" onBlur="extractNumber(this,2,false)" onKeyUp="extractNumber(this,2,false)" onKeyPress="return blockNonNumbers(this, event, true, false);"/>
                             </td>
                             <td height="25" colspan="2" align="left" valign="middle">&nbsp;</td>
                           </tr>
                           <tr>
                             <td align="left" valign="middle" class="text1">Rate of depreciation  :</td>
                             <td height="30" align="left" valign="bottom" class="text1"><input name="rate_of_depreciation" type="text" class="validate[required] textfield121" id="rate_of_depreciation" onBlur="extractNumber(this,2,false)" onKeyUp="extractNumber(this,2,false)" onKeyPress="return blockNonNumbers(this, event, true, false);"/></td>
                             <td height="25" colspan="2" align="left" valign="middle">&nbsp;</td>
                           </tr>
                           <tr>
                        ...
                        <tr>
                             ...
                             <td height="30" align="left" valign="bottom" class="text1">
                            <select name="firms" class="validate[required]" id="firms" style="border:1px solid #CCC; height:25px; width:150px;">
                            <option value="">--Select--</option>
