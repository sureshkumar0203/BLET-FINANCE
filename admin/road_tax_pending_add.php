...
if($_REQUEST["action"] == "insert"){
	...
	$string="vehicle_id='$vehicle_id',tax_from_dt ='$_POST[tax_from_dt]', tax_to_dt ='$_POST[tax_to_dt]',tax_amount ='$_POST[tax_amount]',alert_tax='$_POST[alert_tax]',status='0'";
	$dbf->insertSet("roadtax_pending",$string);
        ...
        <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0" style="border:solid 1px; border-color:#CCC;">
              ...
              <?php 
				$veh_info=$dbf->strRecordID('vehicle_registration', "*", "id='$_REQUEST[vehicle_id]'");
				$rto = $dbf->strRecordID("rto_office" , "*", "id='$veh_info[rto_office]'");
				$veh_typ=$dbf->fetchSingle("vehicle_types","id='$veh_info[vehicle_type]'");	
				$firm=$dbf->fetchSingle("firms","id='$veh_info[firm_name]'");
				?>
              <tr>
                <td align="left" valign="top" >
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        <td colspan="2" align="center" valign="top"><table width="20%" border="1" bordercolor="#FF9900" cellspacing="0" cellpadding="0" style="box-shadow: 5px 3px 55px #FC0; border-collapse:collapse;">
                          ...
                          <br>
                          <form name="frm" id="frm" method="post" action="road_tax_pending_add.php?action=insert">
                          <table width="60%" border="0" cellspacing="0" cellpadding="0" style="border:solid 1px; border-color:#CCC;">
                            <tr>
                              <td width="20%" align="right" valign="middle" class="text2">&nbsp;<input type="hidden" name="vehicle_id" id="vehicle_id" value="<?php echo $_REQUEST["vehicle_id"];?>"></td>
                            ...
                            <tr>
                              ...
                              <td width="30%" align="left" valign="middle"><input name="tax_from_dt" type="text" class="datepick validate[required] textfield121" id="tax_from_dt" readonly="readonly"/></td>
                              ...
                              <td width="29%" align="left" valign="middle"><span class="fetch_contents" style="padding-left:3px;">
                                <input name="tax_to_dt" type="text" class="datepick validate[required] textfield121" id="tax_to_dt" readonly="readonly" value="<?php echo $res_tax[tax_to_dt]; ?>"/>
                              </span></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                              ...
                              <td align="left" valign="middle"><span class="fetch_contents" style="padding-left:3px;">
                                <input name="alert_tax" type="text" class="validate[required] textfield121d" id="alert_tax" onBlur="extractNumber(this,2,false)" onKeyUp="extractNumber(this,2,false)" onKeyPress="return blockNonNumbers(this, event, true, false);"/>
                              </span></td>
                              <td align="left" valign="middle">&nbsp;</td>
                              <td align="right" valign="middle" class="text2">&nbsp;</td>
                              <td align="left" valign="middle">&nbsp;</td>
