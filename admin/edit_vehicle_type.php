...
$res=$db->fetchSingle("vehicle_types","id='$_REQUEST[id]'");

if(isset($_POST[submit])<>'')
{
	$num=$db->countRows('vehicle_types',"vtype='$_POST[vtype]' AND id!=$_REQUEST[id]");
	if($num>0)
	{
		header("Location:edit_vehicle_type.php?id=$_REQUEST[id]&msg=exist");
	}
	else
	{
		//Update vehicle_types table
		$string="vtype='$_POST[vtype]'";
		$db->updateTable("vehicle_types",$string,"id='$_REQUEST[id]'");
		header("Location:edit_vehicle_type.php?id=$_REQUEST[id]&msg=updated");
	}
}
                ...
                <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <td class="midboxbg"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td width="50%" align="left" valign="middle"><h2>Edit Vehicle Type </h2></td>
                  ...
                  <tr>
					...
					<form action="" method="post" id="frm" enctype="multipart/form-data">
                      <table width="90%" border="0" align="left" cellpadding="0" cellspacing="0" style="margin-left:10px;">
                        ...
                        <tr>
                          <td align="left" valign="middle" class="text1">Vehicle Type : </td>
                          <td height="25" align="left" valign="bottom" class="text1">
						  <input name="vtype" type="text" class="validate[required] textfield2" id="vtype" value="<?php echo $res[vtype]; ?>"></td>
                        ...
                        <tr>
                          <td align="left">&nbsp;</td>
                          <td height="40" colspan="6" align="left"><input name="submit" type="submit" class="button" id="submit" value="Submit">&nbsp;               					    <input name="submit2" type="button" class="button" id="submit2" value="Cancel" onClick="javascript:window.location='manage_vehicle_type.php'"></td>
                          </tr>
                        <tr>
                          <td align="left">&nbsp;</td>
                          <td align="left">&nbsp;</td>
