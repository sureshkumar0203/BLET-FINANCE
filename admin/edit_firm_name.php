...
$firm = $db->fetchSingle("firms", "id='$_REQUEST[id]'");

if(isset($_POST["submit"])<>'')
{
	$num=$db->countRows('firms',"firm_name='$_POST[firm_name]' AND id!='$_REQUEST[id]'");
	if($num>0)
	{
		header("Location:edit_firm_name.php?id=$_REQUEST[id]&msg=exist");
	}
	else
	{
		//update firms table
		$string="firm_name='$_POST[firm_name]'";
		$db->updateTable("firms",$string,"id='$_REQUEST[id]'");
		header("Location:edit_firm_name.php?id=$_REQUEST[id]&msg=added");
	}
}
?>
                ...
                <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <td class="midboxbg"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td width="50%" align="left" valign="middle"><h2>Edit Firm </h2></td>
					...
					<form action="" method="post" id="frm" enctype="multipart/form-data">
                      <table width="90%" border="0" align="left" cellpadding="0" cellspacing="0" style="margin-left:10px;">
                        ...
                        <tr>
						  ...
						  <input name="firm_name" type="text" class="validate[required] textfield2" id="firm_name" value="<?php echo $firm["firm_name"]; ?>"></td>
                        ...
                        <tr>
                          <td align="left">&nbsp;</td>
                          <td height="40" colspan="6" align="left"><input name="submit" type="submit" class="button" id="submit" value="Submit">&nbsp;<input name="submit2" type="button" class="button" id="submit2" value="Cancel" onClick="javascript:window.location='manage_firm_name.php'"></td>
                          </tr>
                        <tr>
                          <td align="left">&nbsp;</td>
                          <td align="left">&nbsp;</td>
